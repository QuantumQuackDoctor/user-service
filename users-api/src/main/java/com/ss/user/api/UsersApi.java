...
public interface UsersApi {
    ...
    default ResponseEntity<Void> deleteUsers(@ApiParam(value = "userId"  )  @Valid @RequestBody(required = false) String body) {
    ...
    default ResponseEntity<User> putUsers(@ApiParam(value = ""  )  @Valid @RequestBody(required = false) User user) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"veteranStatus\" : true, \"firstName\" : \"firstName\", \"lastName\" : \"lastName\", \"settings\" : { \"theme\" : \"light\", \"notifications\" : { \"text\" : true, \"email\" : true } }, \"password\" : \"password\", \"DOB\" : \"2021-02-10T00:00:00.000Z\", \"id\" : \"id\", \"email\" : \"email@example.com\", \"points\" : 0 }";
    ...
    default ResponseEntity<Void> updateUser(@ApiParam(value = "User to update"  )  @Valid @RequestBody(required = false) User user) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
